...
namespace InventoryManagementSystem
{
    internal class PdfGenerator
    {
        ...
        public async void GeneratePdfInvoice(Invoice invoice)
        {
            ...
            saveFileDialog.Title = "Save PDF Invoice";

            // set the default file name based on the invoice information
            string defaultFileName = $"{"KAP-" + invoice.sequence}.pdf";
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                Image logo = new Image(ImageDataFactory.Create(new Uri("https://github.com/MAGHPMallawaarachchi/InventoryManagementSystem/blob/main/InventoryManagementSystem/Resources/logo.png?raw=true")));
